...
namespace System
{
    ...
    public class MessageWindow
    {
        ...
        {
            return All.Window.MessageWindow.Show(text, title, button, MessageBoxIcon.Information);
        }
        /// <summary>
        /// 显示消息
        /// </summary>
        ...
        {
            return All.Window.MessageWindow.Show(text, title, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
